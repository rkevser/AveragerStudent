'''
Following distilaltion distills knowledge from a normal/nasty teacher to
...
student model.
'''
# train an averager student network distilling from teacher, in a manner of training scheme of skeptical student

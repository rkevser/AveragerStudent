...
student model.
'''
# train a skeptical student network distilling from teacher
...
parser.add_argument('--augm', type=bool, default=False)
...
if __name__ == "__main__":
    ...
    # # and the corresponding FC layer output where we used KD from the nasty/normal teacher, for skeptical student.
